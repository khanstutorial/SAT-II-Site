...
def makeFile(nbrhood):
    ...
    titleString = "id=\"Neighborhood Title\">SAT II - Khan's Tutorial</title>"
    bannerString = "id=\"Neighborhood 1\">SAT II Tutoring</h1>"
    featureString = "Why do families choose Khan's"
    newTString = titleString.replace("SAT II - Khan's Tutorial</title>",nbrhood.replace('-',' ')+" SAT II - Khan's Tutorial</title>")
    newBString = bannerString.replace("SAT II Tutoring</h1>",nbrhood.replace('-',' ')+" SAT II Tutoring</h1>")
